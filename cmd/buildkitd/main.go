...
import (
	...
	"github.com/talos-riscv/buildkit/cache/remotecache"
	"github.com/talos-riscv/buildkit/cache/remotecache/azblob"
	"github.com/talos-riscv/buildkit/cache/remotecache/gha"
	inlineremotecache "github.com/talos-riscv/buildkit/cache/remotecache/inline"
	localremotecache "github.com/talos-riscv/buildkit/cache/remotecache/local"
	registryremotecache "github.com/talos-riscv/buildkit/cache/remotecache/registry"
	s3remotecache "github.com/talos-riscv/buildkit/cache/remotecache/s3"
	"github.com/talos-riscv/buildkit/client"
	"github.com/talos-riscv/buildkit/cmd/buildkitd/config"
	"github.com/talos-riscv/buildkit/control"
	...
	"github.com/talos-riscv/buildkit/frontend/gateway/forwarder"
	"github.com/talos-riscv/buildkit/session"
	"github.com/talos-riscv/buildkit/solver"
	"github.com/talos-riscv/buildkit/solver/bboltcachestorage"
	...
	"github.com/talos-riscv/buildkit/util/archutil"
	...
	"github.com/talos-riscv/buildkit/util/profiler"
	"github.com/talos-riscv/buildkit/util/resolver"
	...
	_ "github.com/talos-riscv/buildkit/util/tracing/detect/jaeger"
	_ "github.com/talos-riscv/buildkit/util/tracing/env"
	"github.com/talos-riscv/buildkit/util/tracing/transform"
...
func main() {
	...
	app.Action = func(c *cli.Context) error {
		...
		// https://github.com/talos-riscv/buildkit/issues/4618
